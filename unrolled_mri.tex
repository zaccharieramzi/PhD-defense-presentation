...
\begin{frame}[plain,c]
    ...
    \begin{center}
        \color{DarkBlue}
    \Huge Deep Learning for MRI reconstruction
    \end{center}
...
\begin{frame}{Unrolled models for MRI reconstruction}
    ...
    \begin{block}{Recap}
        ...
        We showcased 2 instances of unrolled models which can perform really well in challenging acquisition settings.
    \end{block}
