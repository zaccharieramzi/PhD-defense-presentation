...
\begin{frame}{Nuclear Magnetic Resonance}
    \begin{center}
        \begin{tikzpicture}[
            ...
            % \draw[->,dashed,semithick] (0:180:2 and 0.6) arc[radius=1.2, start angle=150, end angle=210];
            % \draw[->,>=stealth',semithick] (-30:1.2cm) arc[radius=1.2, start angle=-30, end angle=30];
            % \draw[dashed,->,semithick] arc (0:180:2 and 0.6);
            \begin{scope}[on background layer]
                \draw[->,dashed,semithick] (-0.6cm,1.6cm) arc [start angle=180, end angle=-70, x radius=0.6cm, y radius=.1cm];                
            \end{scope}
            %% arrow spin
            %%% init
            \draw<1>[->,spin] (-0.3cm,0.8cm) -- (-0.6cm,1.6cm);
            \begin{scope}[on background layer]
                \draw<1>[spin] (0.3cm,-0.8cm) -- (0.6cm,-1.6cm);
            \end{scope}
