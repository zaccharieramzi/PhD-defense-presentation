...
\begin{frame}{Additional contribution}
    ...
    \end{exampleblock}
    \begin{center}
        \includegraphics[height=0.5\textheight]{Figures/pysap_team.pdf}
        \includegraphics[height=0.1\textheight]{Figures/pysap_logo.png}
    \end{center}
    \begin{center}
        \faPython \thickspace \highlight{black}{\texttt{pip install python-pysap}}
    \end{center}
\end{frame}
