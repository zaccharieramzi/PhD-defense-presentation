...
\begin{frame}{Learnlets}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/clinic_applic/learnlets_tikz_reduced.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/clinic_applic/reconstruction_samples_1.png}
    \end{figure}
\end{frame}